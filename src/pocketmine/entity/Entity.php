...
use pocketmine\Server;//setDataProperty
...
abstract class Entity extends Location implements Metadatable{
	...
	/** @var AttributeMap */
	protected $attributeMap; //isInsideOfSolid
	...
	public function isAlive(){ //$linkedEntity
...
*/
	...
	public function sendLinkedData(){
		if($this->linkedEntity instanceof Entity){
			$this->setLinked($this->linkedType, $this->linkedEntity); //isInsideOfPortal
		}
	}
